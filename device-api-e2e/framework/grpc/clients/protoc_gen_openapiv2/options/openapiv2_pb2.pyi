...
class Swagger(google.protobuf.message.Message):
    ...
    def responses(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Response]:
    ...
    def __init__(
        ...
        *,
        ...
        responses: typing.Optional[
            typing.Mapping[typing.Text, global___Response]
        ] = ...,
...
class Response(google.protobuf.message.Message):
    ...
    def headers(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Header]:
    ...
    def __init__(
        ...
        *,
        ...
        type: typing.Optional[
            typing.Iterable[global___JSONSchema.JSONSchemaSimpleTypes.ValueType]
        ] = ...,
        format: typing.Text = ...,
        enum: typing.Optional[typing.Iterable[typing.Text]] = ...,
        field_configuration: typing.Optional[
            global___JSONSchema.FieldConfiguration
        ] = ...,
        extensions: typing.Optional[
            typing.Mapping[typing.Text, google.protobuf.struct_pb2.Value]
        ] = ...,
...
class Tag(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "description", b"description", "external_docs", b"external_docs"
        ],
    ) -> None: ...
...
class SecurityDefinitions(google.protobuf.message.Message):
    ...
    def security(
        ...
        typing.Text, global___SecurityScheme
    ]:
    ...
    def __init__(
        ...
        *,
        security: typing.Optional[
            typing.Mapping[typing.Text, global___SecurityScheme]
        ] = ...,
    ) -> None: ...
    def ClearField(
...
class SecurityRequirement(google.protobuf.message.Message):
    ...
    def security_requirement(
        ...
        typing.Text, global___SecurityRequirement.SecurityRequirementValue
    ]:
    ...
    def __init__(
        self,
        *,
        security_requirement: typing.Optional[
            typing.Mapping[
                typing.Text, global___SecurityRequirement.SecurityRequirementValue
            ]
        ] = ...,
