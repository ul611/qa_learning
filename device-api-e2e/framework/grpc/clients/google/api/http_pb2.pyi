...
class HttpRule(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["pattern", b"pattern"]
    ) -> typing.Optional[
        typing_extensions.Literal["get", "put", "post", "delete", "patch", "custom"]
    ]: ...
...
class CustomHttpPattern(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["kind", b"kind", "path", b"path"]
    ) -> None: ...
